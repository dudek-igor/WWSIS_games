 class Game {
    ...
    render(colors = ['grey','grey','grey'], money = this.wallet.getWalletValue(),result = '',stats = [0,0,0], bid = 0, wonManey = 0){
    ...
    startGame(){
      if(this.inputBit.value < 1) return alert('Kwota, którą chcesz grać jest za mała!') 
      const bid = Math.floor(this.inputBit.value);
      if(!this.wallet.checkCanPlay(bid)){
        return alert('Masz za mało środków lub podana została nie prawidłowa wartość')
      }
